...
import { TmdbTvEpisodeGroupDetailDto } from '../dtos/tv-episode-groups/tv-episode-group-detail.dto';
import { BaseMediaService } from './base-media.service';

@Injectable({ providedIn: 'root' })
export class TmdbTvEpisodeGroupsService extends BaseMediaService {
    /**
    ...
    getTvEpisodeGroupDetails(episodeGroupId: string): Observable<TmdbTvEpisodeGroupDetailDto> {
        return this.http.get<TmdbTvEpisodeGroupDetailDto>(`${this.apiPrefix}/tv/episode_group/${episodeGroupId}`);
    }
}