...
} from '../dtos/watch-providers/watch-provider.dto';
import { BaseMediaService } from './base-media.service';

@Injectable({ providedIn: 'root' })
export class TmdbWatchProvidersService extends BaseMediaService {
    /*
    ...
    */
     ...
     */
    getAvailableRegions(language = 'en-US'): Observable<TmdbWatchRegionsResponseDto> {
        const params = new HttpParams().set('language', language);
        return this.http.get<TmdbWatchRegionsResponseDto>(`${this.apiPrefix}/watch/providers/regions`, { params });
    }
    ...
    getMovieProviders(
        ...
        return this.http.get<TmdbGlobalWatchProvidersResponseDto>(`${this.apiPrefix}/watch/providers/movie`, { params });
    }
    ...
    getTvProviders(
        ...
        return this.http.get<TmdbGlobalWatchProvidersResponseDto>(`${this.apiPrefix}/watch/providers/tv`, { params });
    }
}