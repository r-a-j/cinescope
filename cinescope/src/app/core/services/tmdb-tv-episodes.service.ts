...
import { TmdbTvEpisodeDetailDto } from '../dtos/tv-episodes/tv-episode-detail.dto';
import { TmdbTvEpisodeChangesResponseDto } from '../dtos/tv-episodes/tv-episode-changes.dto';
import { TmdbTvEpisodeVideosResponseDto } from '../dtos/tv-episodes/tv-episode-videos.dto';
import { TmdbTvEpisodeCreditsResponseDto } from '../dtos/tv-episodes/tv-episode-credits.dto';
import { TmdbTvEpisodeExternalIdsDto } from '../dtos/tv-episodes/tv-episode-external-ids.dto';
import { TmdbTvEpisodeImagesResponseDto } from '../dtos/tv-episodes/tv-episode-images.dto';
import { TmdbTvEpisodeTranslationsResponseDto } from '../dtos/tv-episodes/tv-episode-translations.dto';
import { BaseMediaService } from './base-media.service';

@Injectable({ providedIn: 'root' })
export class TmdbTvEpisodesService extends BaseMediaService {
    /**
    ...
    getTvEpisodeDetails(
        ...
        return this.http.get<TmdbTvEpisodeDetailDto>(
            `${this.apiPrefix}/tv/${seriesId}/season/${seasonNumber}/episode/${episodeNumber}`,
            { params }
        );
    }
     ...
     */
    getTvEpisodeCredits(seriesId: number, seasonNumber: number, episodeNumber: number, language = 'en-US'): Observable<TmdbTvEpisodeCreditsResponseDto> {
        const params = this.buildParams({ language });
        return this.http.get<TmdbTvEpisodeCreditsResponseDto>(`${this.apiPrefix}/tv/${seriesId}/season/${seasonNumber}/episode/${episodeNumber}/credits`, { params });
    }
    ...
    getTvEpisodeExternalIds(seriesId: number, seasonNumber: number, episodeNumber: number): Observable<TmdbTvEpisodeExternalIdsDto> {
        return this.http.get<TmdbTvEpisodeExternalIdsDto>(`${this.apiPrefix}/tv/${seriesId}/season/${seasonNumber}/episode/${episodeNumber}/external_ids`);
    }
    ...
    getTvEpisodeImages(seriesId: number, seasonNumber: number, episodeNumber: number, language?: string): Observable<TmdbTvEpisodeImagesResponseDto> {
        const params = this.buildParams({ language });
        return this.http.get<TmdbTvEpisodeImagesResponseDto>(`${this.apiPrefix}/tv/${seriesId}/season/${seasonNumber}/episode/${episodeNumber}/images`, { params });
    }
    ...
    getTvEpisodeTranslations(seriesId: number, seasonNumber: number, episodeNumber: number): Observable<TmdbTvEpisodeTranslationsResponseDto> {
        return this.http.get<TmdbTvEpisodeTranslationsResponseDto>(`${this.apiPrefix}/tv/${seriesId}/season/${seasonNumber}/episode/${episodeNumber}/translations`);
    }
    ...
    getTvEpisodeVideos(seriesId: number, seasonNumber: number, episodeNumber: number, language?: string, includeVideoLanguage?: string): Observable<TmdbTvEpisodeVideosResponseDto> {
        ...
        return this.http.get<TmdbTvEpisodeVideosResponseDto>(`${this.apiPrefix}/tv/${seriesId}/season/${seasonNumber}/episode/${episodeNumber}/videos`, { params });
    }
     ...
     */
    getTvEpisodeChanges(episodeId: number, startDate?: string, endDate?: string, page = 1): Observable<TmdbTvEpisodeChangesResponseDto> {
        let params = this.buildParams({ page });
        if (startDate) params = params.set('start_date', startDate);
        if (endDate) params = params.set('end_date', endDate);
        return this.http.get<TmdbTvEpisodeChangesResponseDto>(`${this.apiPrefix}/tv/episode/${episodeId}/changes`, { params });
    }
}