...
import { TmdbNowPlayingResponseDto } from '../dtos/movies/now-playing.dto';
...
import { TmdbUpcomingResponseDto } from '../dtos/movies/upcoming.dto';
import { TmdbMovieDetailDto } from '../dtos/movies/movie-detail.dto';
import { TmdbMovieAlternativeTitlesResponseDto } from '../dtos/movies/movie-alternative-titles.dto';
import { TmdbMovieChangesResponseDto } from '../dtos/movies/movie-changes.dto';
import { TmdbMovieCreditsResponseDto } from '../dtos/movies/movie-credits.dto';
import { TmdbMovieExternalIdsDto } from '../dtos/movies/movie-external-ids.dto';
import { TmdbMovieImagesResponseDto } from '../dtos/movies/movie-images.dto';
import { TmdbMovieKeywordsResponseDto } from '../dtos/movies/movie-keywords.dto';
import { TmdbMovieListReferenceDto } from '../dtos/movies/movie-list-reference.dto';
import { TmdbMovieReleaseDatesResponseDto } from '../dtos/movies/movie-release-dates.dto';
import { TmdbReviewDto } from '../dtos/reviews/review.dto';
import { TmdbMovieTranslationsResponseDto } from '../dtos/movies/movie-translations.dto';
import { TmdbMovieVideosResponseDto } from '../dtos/movies/movie-videos.dto';
import { TmdbMovieWatchProvidersResponseDto } from '../dtos/movies/movie-watch-providers.dto';
import { BaseMediaService } from './base-media.service';

@Injectable({ providedIn: 'root' })
export class TmdbMoviesService extends BaseMediaService {
    /**
     * Get an up to date list of the officially supported movie certifications on TMDB.
     */
    getMovieCertifications(): Observable<TmdbCertificationResponseDto> {
        return this.http.get<TmdbCertificationResponseDto>(`${this.apiPrefix}/certification/movie/list`);
    }
    ...
    getNowPlayingMovies(
        ...
        return this.http.get<TmdbNowPlayingResponseDto>(`${this.apiPrefix}/movie/now_playing`, { params });
    }
    ...
    getPopularMovies(
        ...
        return this.http.get<TmdbPaginatedResponseDto<TmdbMovieListItemDto>>(`${this.apiPrefix}/movie/popular`, { params });
    }
    ...
    getTopRatedMovies(
        ...
        return this.http.get<TmdbPaginatedResponseDto<TmdbMovieListItemDto>>(`${this.apiPrefix}/movie/top_rated`, { params });
    }
    ...
    getUpcomingMovies(
        ...
        return this.http.get<TmdbUpcomingResponseDto>(`${this.apiPrefix}/movie/upcoming`, { params });
    }
    ...
    getMovieDetails(
        ...
        return this.http.get<TmdbMovieDetailDto>(`${this.apiPrefix}/movie/${movieId}`, { params });
    }
    ...
    getMovieAlternativeTitles(movieId: number, country?: string): Observable<TmdbMovieAlternativeTitlesResponseDto> {
        ...
        return this.http.get<TmdbMovieAlternativeTitlesResponseDto>(`${this.apiPrefix}/movie/${movieId}/alternative_titles`, { params });
    }
    ...
    getMovieChanges(
        ...
        return this.http.get<TmdbMovieChangesResponseDto>(`${this.apiPrefix}/movie/${movieId}/changes`, { params });
    }
     ...
     */
    getMovieCredits(movieId: number, language = 'en-US'): Observable<TmdbMovieCreditsResponseDto> {
        const params = new HttpParams().set('language', language);
        return this.http.get<TmdbMovieCreditsResponseDto>(`${this.apiPrefix}/movie/${movieId}/credits`, { params });
    }
    ...
    getMovieExternalIds(movieId: number): Observable<TmdbMovieExternalIdsDto> {
        return this.http.get<TmdbMovieExternalIdsDto>(`${this.apiPrefix}/movie/${movieId}/external_ids`);
    }
    ...
    getMovieImages(
        ...
        return this.http.get<TmdbMovieImagesResponseDto>(`${this.apiPrefix}/movie/${movieId}/images`, { params });
    }
    ...
    getMovieKeywords(movieId: number): Observable<TmdbMovieKeywordsResponseDto> {
        return this.http.get<TmdbMovieKeywordsResponseDto>(`${this.apiPrefix}/movie/${movieId}/keywords`);
    }
    ...
    getLatestMovie(): Observable<TmdbMovieDetailDto> {
        return this.http.get<TmdbMovieDetailDto>(`${this.apiPrefix}/movie/latest`);
    }
    ...
    getMovieLists(
        ...
        return this.http.get<TmdbPaginatedResponseDto<TmdbMovieListReferenceDto>>(`${this.apiPrefix}/movie/${movieId}/lists`, { params });
    }
    ...
    getMovieRecommendations(
        ...
        return this.http.get<TmdbPaginatedResponseDto<TmdbMovieListItemDto>>(`${this.apiPrefix}/movie/${movieId}/recommendations`, { params });
    }
    ...
    getMovieReleaseDates(movieId: number): Observable<TmdbMovieReleaseDatesResponseDto> {
        return this.http.get<TmdbMovieReleaseDatesResponseDto>(`${this.apiPrefix}/movie/${movieId}/release_dates`);
    }
    ...
    getMovieReviews(
        ...
        return this.http.get<TmdbPaginatedResponseDto<TmdbReviewDto>>(`${this.apiPrefix}/movie/${movieId}/reviews`, { params });
    }
    ...
    getSimilarMovies(
        ...
        return this.http.get<TmdbPaginatedResponseDto<TmdbMovieListItemDto>>(`${this.apiPrefix}/movie/${movieId}/similar`, { params });
    }
    ...
    getMovieTranslations(movieId: number): Observable<TmdbMovieTranslationsResponseDto> {
        return this.http.get<TmdbMovieTranslationsResponseDto>(`${this.apiPrefix}/movie/${movieId}/translations`);
    }
     ...
     */
    getMovieVideos(movieId: number, language = 'en-US'): Observable<TmdbMovieVideosResponseDto> {
        const params = new HttpParams().set('language', language);
        return this.http.get<TmdbMovieVideosResponseDto>(`${this.apiPrefix}/movie/${movieId}/videos`, { params });
    }
    ...
    getMovieWatchProviders(movieId: number): Observable<TmdbMovieWatchProvidersResponseDto> {
        return this.http.get<TmdbMovieWatchProvidersResponseDto>(`${this.apiPrefix}/movie/${movieId}/watch/providers`);
    }
}