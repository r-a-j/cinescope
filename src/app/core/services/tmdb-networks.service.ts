...
import { TmdbNetworkDetailDto } from '../dtos/networks/network-detail.dto';
import { TmdbNetworkAlternativeNamesResponseDto } from '../dtos/networks/network-alternative-names.dto';
import { TmdbNetworkImagesResponseDto } from '../dtos/networks/network-images.dto';
import { BaseMediaService } from './base-media.service';

@Injectable({ providedIn: 'root' })
export class TmdbNetworksService extends BaseMediaService {
    /**
    ...
    getNetworkDetails(networkId: number): Observable<TmdbNetworkDetailDto> {
        return this.http.get<TmdbNetworkDetailDto>(`${this.apiPrefix}/network/${networkId}`);
    }
    ...
    getNetworkAlternativeNames(networkId: number): Observable<TmdbNetworkAlternativeNamesResponseDto> {
        return this.http.get<TmdbNetworkAlternativeNamesResponseDto>(`${this.apiPrefix}/network/${networkId}/alternative_names`);
    }
    ...
    getNetworkImages(networkId: number): Observable<TmdbNetworkImagesResponseDto> {
        return this.http.get<TmdbNetworkImagesResponseDto>(`${this.apiPrefix}/network/${networkId}/images`);
    }
}