...
import { TmdbTrendingMixedItemDto } from '../../models/tmdb/trending/trending-mixed-item.dto';
...
export class TmdbTrendingService {
    ...
    getTrendingAll(
        ...
        return this.http.get<TmdbPaginatedResponseDto<TmdbTrendingMixedItemDto>>(`/trending/all/${timeWindow}`, { params });
    }
    ...
    getTrendingMovies(
        ...
        const params = new HttpParams().set('language', language);
        return this.http.get<TmdbPaginatedResponseDto<TmdbMovieListItemDto>>(`/trending/movie/${timeWindow}`, { params });
    }
    ...
    getTrendingTvShows(
        ...
        const params = new HttpParams().set('language', language);
        return this.http.get<TmdbPaginatedResponseDto<TmdbTvListItemDto>>(`/trending/tv/${timeWindow}`, { params });
    }
    ...
    getTrendingPeople(
        ...
        const params = new HttpParams().set('language', language);
        return this.http.get<TmdbPaginatedResponseDto<TmdbPersonListItemDto>>(`/trending/person/${timeWindow}`, { params });
    }
}