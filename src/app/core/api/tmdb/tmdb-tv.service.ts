...
import { TmdbTvDetailDto } from '../../models/tmdb/tv/tv-detail.dto';
import { TmdbTvAggregateCreditsResponseDto } from '../../models/tmdb/tv/tv-aggregate-credits.dto';
import { TmdbTvAlternativeTitlesResponseDto } from '../../models/tmdb/tv/tv-alternative-titles.dto';
import { TmdbTvChangesResponseDto } from '../../models/tmdb/tv/tv-changes.dto';
import { TmdbTvContentRatingsResponseDto } from '../../models/tmdb/tv/tv-content-ratings.dto';
import { TmdbTvCreditsResponseDto } from '../../models/tmdb/tv/tv-credits.dto';
import { TmdbTvEpisodeGroupsResponseDto } from '../../models/tmdb/tv/tv-episode-groups.dto';
import { TmdbTvExternalIdsDto } from '../../models/tmdb/tv/tv-external-ids.dto';
import { TmdbTvImagesResponseDto } from '../../models/tmdb/tv/tv-images.dto';
import { TmdbTvKeywordsResponseDto } from '../../models/tmdb/tv/tv-keywords.dto';
import { TmdbTvListResultDto } from '../../models/tmdb/tv/tv-list-result.dto';
import { TmdbReviewDto } from '../../models/tmdb/reviews/review.dto';
import { TmdbTvScreenedTheatricallyResponseDto } from '../../models/tmdb/tv/tv-screened-theatrically.dto';
import { TmdbTvTranslationsResponseDto } from '../../models/tmdb/tv/tv-translations.dto';
import { TmdbTvVideosResponseDto } from '../../models/tmdb/tv/tv-videos.dto';
import { TmdbTvWatchProvidersResponseDto } from '../../models/tmdb/tv/tv-watch-providers.dto';
...
export class TmdbTvService {
    ...
    getTvAiringToday(
        ...
        return this.http.get<TmdbPaginatedResponseDto<TmdbTvListItemDto>>('/tv/airing_today', { params });
    }
    ...
    getTvOnTheAir(
        ...
        return this.http.get<TmdbPaginatedResponseDto<TmdbTvListItemDto>>('/tv/on_the_air', { params });
    }
    ...
    getPopularTvShows(
        ...
        return this.http.get<TmdbPaginatedResponseDto<TmdbTvListItemDto>>('/tv/popular', { params });
    }
    ...
    getTopRatedTvShows(
        ...
        return this.http.get<TmdbPaginatedResponseDto<TmdbTvListItemDto>>('/tv/top_rated', { params });
    }
    ...
    getTvShowDetails(
        ...
        return this.http.get<TmdbTvDetailDto>(`/tv/${seriesId}`, { params });
    }
    ...
    getTvAggregateCredits(
        ...
        return this.http.get<TmdbTvAggregateCreditsResponseDto>(`/tv/${seriesId}/aggregate_credits`, { params });
    }
    ...
    getTvAlternativeTitles(seriesId: number): Observable<TmdbTvAlternativeTitlesResponseDto> {
        return this.http.get<TmdbTvAlternativeTitlesResponseDto>(`/tv/${seriesId}/alternative_titles`);
    }
    ...
    getTvChanges(
        ...
        return this.http.get<TmdbTvChangesResponseDto>(`/tv/${seriesId}/changes`, { params });
    }
    ...
    getTvContentRatings(seriesId: number): Observable<TmdbTvContentRatingsResponseDto> {
        return this.http.get<TmdbTvContentRatingsResponseDto>(`/tv/${seriesId}/content_ratings`);
    }
    ...
    getTvCredits(
        ...
        const params = new HttpParams().set('language', language);
        return this.http.get<TmdbTvCreditsResponseDto>(`/tv/${seriesId}/credits`, { params });
    }
    ...
    getTvEpisodeGroups(seriesId: number): Observable<TmdbTvEpisodeGroupsResponseDto> {
        return this.http.get<TmdbTvEpisodeGroupsResponseDto>(`/tv/${seriesId}/episode_groups`);
    }
    ...
    getTvExternalIds(seriesId: number): Observable<TmdbTvExternalIdsDto> {
        return this.http.get<TmdbTvExternalIdsDto>(`/tv/${seriesId}/external_ids`);
    }
    ...
    getTvImages(
        ...
        return this.http.get<TmdbTvImagesResponseDto>(`/tv/${seriesId}/images`, { params });
    }
    ...
    * * @param seriesId The TMDB TV Show ID.
    ...
    getTvKeywords(seriesId: number): Observable<TmdbTvKeywordsResponseDto> {
        return this.http.get<TmdbTvKeywordsResponseDto>(`/tv/${seriesId}/keywords`);
    }
    ...
    getLatestTvShow(): Observable<TmdbTvDetailDto> {
        return this.http.get<TmdbTvDetailDto>('/tv/latest');
    }
    ...
    getTvLists(
        ...
        return this.http.get<TmdbPaginatedResponseDto<TmdbTvListResultDto>>(`/tv/${seriesId}/lists`, { params });
    }
    ...
    getTvRecommendations(
        ...
        return this.http.get<TmdbPaginatedResponseDto<TmdbTvListItemDto>>(`/tv/${seriesId}/recommendations`, { params });
    }
    ...
    getTvReviews(
        ...
        return this.http.get<TmdbPaginatedResponseDto<TmdbReviewDto>>(`/tv/${seriesId}/reviews`, { params });
    }
    ...
    getTvScreenedTheatrically(seriesId: number): Observable<TmdbTvScreenedTheatricallyResponseDto> {
        return this.http.get<TmdbTvScreenedTheatricallyResponseDto>(`/tv/${seriesId}/screened_theatrically`);
    }
    ...
    getSimilarTvShows(
        ...
        return this.http.get<TmdbPaginatedResponseDto<TmdbTvListItemDto>>(`/tv/${seriesId}/similar`, { params });
    }
    ...
    getTvTranslations(seriesId: number): Observable<TmdbTvTranslationsResponseDto> {
        return this.http.get<TmdbTvTranslationsResponseDto>(`/tv/${seriesId}/translations`);
    }
    ...
    getTvVideos(
        ...
        return this.http.get<TmdbTvVideosResponseDto>(`/tv/${seriesId}/videos`, { params });
    }
    ...
    getTvWatchProviders(seriesId: number): Observable<TmdbTvWatchProvidersResponseDto> {
        return this.http.get<TmdbTvWatchProvidersResponseDto>(`/tv/${seriesId}/watch/providers`);
    }
}