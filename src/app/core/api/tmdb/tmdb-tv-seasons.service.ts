...
import { TmdbTvSeasonDetailDto } from '../../models/tmdb/tv-seasons/tv-season-detail.dto';
import { TmdbTvSeasonAggregateCreditsResponseDto } from '../../models/tmdb/tv-seasons/tv-season-aggregate-credits.dto';
import { TmdbTvSeasonChangesResponseDto } from '../../models/tmdb/tv-seasons/tv-season-changes.dto';
import { TmdbTvSeasonCreditsResponseDto } from '../../models/tmdb/tv-seasons/tv-season-credits.dto';
import { TmdbTvSeasonExternalIdsDto } from '../../models/tmdb/tv-seasons/tv-season-external-ids.dto';
import { TmdbTvSeasonImagesResponseDto } from '../../models/tmdb/tv-seasons/tv-season-images.dto';
import { TmdbTvSeasonTranslationsResponseDto } from '../../models/tmdb/tv-seasons/tv-season-translations.dto';
import { TmdbTvSeasonVideosResponseDto } from '../../models/tmdb/tv-seasons/tv-season-videos.dto';
import { TmdbTvSeasonWatchProvidersResponseDto } from '../../models/tmdb/tv-seasons/tv-season-watch-providers.dto';

@Injectable({ providedIn: 'root' })
export class TmdbTvSeasonsService {
    ...
    getTvSeasonDetails(
        ...
        return this.http.get<TmdbTvSeasonDetailDto>(`/tv/${seriesId}/season/${seasonNumber}`, { params });
    }
    ...
    getTvSeasonAggregateCredits(
        ...
        return this.http.get<TmdbTvSeasonAggregateCreditsResponseDto>(`/tv/${seriesId}/season/${seasonNumber}/aggregate_credits`, { params });
    }
    ...
    getTvSeasonCredits(
        ...
        const params = new HttpParams().set('language', language);
        return this.http.get<TmdbTvSeasonCreditsResponseDto>(`/tv/${seriesId}/season/${seasonNumber}/credits`, { params });
    }
    ...
    getTvSeasonChanges(
        ...
        return this.http.get<TmdbTvSeasonChangesResponseDto>(`/tv/season/${seasonId}/changes`, { params });
    }
    ...
    getTvSeasonExternalIds(seriesId: number, seasonNumber: number): Observable<TmdbTvSeasonExternalIdsDto> {
        return this.http.get<TmdbTvSeasonExternalIdsDto>(`/tv/${seriesId}/season/${seasonNumber}/external_ids`);
    }
    ...
    getTvSeasonImages(
        ...
        return this.http.get<TmdbTvSeasonImagesResponseDto>(`/tv/${seriesId}/season/${seasonNumber}/images`, { params });
    }
    ...
    getTvSeasonTranslations(seriesId: number, seasonNumber: number): Observable<TmdbTvSeasonTranslationsResponseDto> {
        return this.http.get<TmdbTvSeasonTranslationsResponseDto>(`/tv/${seriesId}/season/${seasonNumber}/translations`);
    }
    ...
    getTvSeasonVideos(
        ...
        return this.http.get<TmdbTvSeasonVideosResponseDto>(`/tv/${seriesId}/season/${seasonNumber}/videos`, { params });
    }
    ...
    getTvSeasonWatchProviders(seriesId: number, seasonNumber: number): Observable<TmdbTvSeasonWatchProvidersResponseDto> {
        return this.http.get<TmdbTvSeasonWatchProvidersResponseDto>(`/tv/${seriesId}/season/${seasonNumber}/watch/providers`);
    }
}