...
import { TmdbPersonListItemDto } from '../../models/tmdb/people/person-list-item.dto';
import { TmdbPersonDetailDto } from '../../models/tmdb/people/person-detail.dto';
import { TmdbPersonChangesResponseDto } from '../../models/tmdb/people/person-changes.dto';
import { TmdbPersonCombinedCreditsResponseDto } from '../../models/tmdb/people/person-combined-credits.dto';
import { TmdbPersonExternalIdsDto } from '../../models/tmdb/people/person-external-ids.dto';
import { TmdbPersonImagesResponseDto } from '../../models/tmdb/people/person-images.dto';
import { TmdbPersonMovieCreditsResponseDto } from '../../models/tmdb/people/person-movie-credits.dto';
import { TmdbPersonTvCreditsResponseDto } from '../../models/tmdb/people/person-tv-credits.dto';
import { TmdbPersonTranslationsResponseDto } from '../../models/tmdb/people/person-translations.dto';
...
export class TmdbPeopleService {
    ...
    getPopularPeople(
        ...
        return this.http.get<TmdbPaginatedResponseDto<TmdbPersonListItemDto>>('/person/popular', { params });
    }
    ...
    getPersonDetails(
        ...
        return this.http.get<TmdbPersonDetailDto>(`/person/${personId}`, { params });
    }
    ...
    getPersonChanges(
        ...
        return this.http.get<TmdbPersonChangesResponseDto>(`/person/${personId}/changes`, { params });
    }
     ...
     */
    getPersonCombinedCredits(personId: number, language: string = 'en-US'): Observable<TmdbPersonCombinedCreditsResponseDto> {
        const params = new HttpParams().set('language', language);
        return this.http.get<TmdbPersonCombinedCreditsResponseDto>(`/person/${personId}/combined_credits`, { params });
    }
    ...
    getPersonExternalIds(personId: number): Observable<TmdbPersonExternalIdsDto> {
        return this.http.get<TmdbPersonExternalIdsDto>(`/person/${personId}/external_ids`);
    }
    ...
    getPersonImages(personId: number): Observable<TmdbPersonImagesResponseDto> {
        return this.http.get<TmdbPersonImagesResponseDto>(`/person/${personId}/images`);
    }
    ...
    getLatestPerson(): Observable<TmdbPersonDetailDto> {
        return this.http.get<TmdbPersonDetailDto>('/person/latest');
    }
     ...
     */
    getPersonMovieCredits(personId: number, language: string = 'en-US'): Observable<TmdbPersonMovieCreditsResponseDto> {
        const params = new HttpParams().set('language', language);
        return this.http.get<TmdbPersonMovieCreditsResponseDto>(`/person/${personId}/movie_credits`, { params });
    }
     ...
     * This allows you to render a distinct "Directed By" carousel, separate from their "Acted In" carousel!
     */
    getPersonTvCredits(personId: number, language: string = 'en-US'): Observable<TmdbPersonTvCreditsResponseDto> {
        const params = new HttpParams().set('language', language);
        return this.http.get<TmdbPersonTvCreditsResponseDto>(`/person/${personId}/tv_credits`, { params });
    }
    ...
    getPersonTranslations(personId: number): Observable<TmdbPersonTranslationsResponseDto> {
        return this.http.get<TmdbPersonTranslationsResponseDto>(`/person/${personId}/translations`);
    }
}